...
from gestor_usuario_roles.models import Estudiante, EstadoCuenta

class Alarm(models.Model):
    estudiante = models.ForeignKey(Estudiante, on_delete=models.CASCADE, default=None)
    cuenta = models.ForeignKey(EstadoCuenta, on_delete=models.CASCADE, default=None)
    ...
    def __str__(self):
        return '{"estudiante": %s, "estado_cuenta": %s, "limitExceeded": %s, "dateTime": %s}' % (self.estudiante.name, self.estadocuenta.pas_y_salvo, self.limitExceeded, self.dateTime)
